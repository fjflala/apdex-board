 ...
 * Module dependencies
 */
const sortByApdex = require('./index').default;

describe('sortByApdex util', () => {
  it('Should sort the apps by apdex', () => {
    ...
    const sorted = sortByApdex(data);

    expect(sorted[0].name).toEqual('Small Fresh Pants - Kautzer - Boyer, and Sons');
  });
});
